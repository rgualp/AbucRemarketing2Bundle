...
class Version20161202170403 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE ownership_ranking_extra ADD endDate DATE NOT NULL, ADD rr INT DEFAULT NULL, ADD ri INT DEFAULT NULL, ADD sd INT DEFAULT NULL, ADD positiveComments INT DEFAULT NULL, ADD awards INT DEFAULT NULL, ADD confidence INT DEFAULT NULL, ADD newOffersReserved INT DEFAULT NULL, ADD failureCasa INT DEFAULT NULL, ADD negativeComments INT DEFAULT NULL, ADD snd INT DEFAULT NULL, ADD penalties INT DEFAULT NULL, ADD failureClients INT DEFAULT NULL, ADD facturation INT DEFAULT NULL, ADD ranking NUMERIC(10, 0) DEFAULT NULL, ADD place INT DEFAULT NULL, ADD destinationPlace INT DEFAULT NULL, ADD rankingPoints INT DEFAULT NULL, DROP uDetailsUpdated, DROP rRrI, DROP rsm, DROP acv, DROP extraRanking, DROP accommodationRanking, DROP comments, CHANGE updateddate startDate DATE NOT NULL');
