...
class Version20150617183131 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("set @accommodationParentId = (SELECT min(nom_id) FROM nomenclatorstat WHERE nom_name LIKE 'Alojamientos')");
        ...
        $this->addSql("set @nomParentId = (SELECT min(nom_id) FROM nomenclatorstat WHERE nom_name LIKE 'Tipos')");
        ...
        $this->addSql("set @nomParentId = (SELECT min(nom_id) FROM nomenclatorstat WHERE nom_name LIKE 'Categorías')");
        ...
        $this->addSql("set @nomParentId = (SELECT min(nom_id) FROM nomenclatorstat WHERE nom_name LIKE 'Idiomas')");
        ...
        $this->addSql("set @nomParentId = (SELECT min(nom_id) FROM nomenclatorstat WHERE nom_name LIKE 'Total de Habitaciones')");
