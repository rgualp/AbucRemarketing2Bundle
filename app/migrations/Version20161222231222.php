 ...
 */
class Version20161222231222 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
        ...
        BEGIN
          ...
          read_loop: LOOP
            ...
            IF @exists = 0 THEN
               ...
               totalAvailableFacturation, totalNonAvailableFacturation)
               ...
               @currentMonthFacturation, @totalFacturation, @totalSolicitudesDisponibles, @snd, @reservations, @totalAvailableFacturation, @totalNonAvailableFacturation);
            ELSE
