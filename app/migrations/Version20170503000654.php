 ...
 */
class Version20170503000654 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        BEGIN
          ...
          read_loop: LOOP
            ...
            set @penalties = (SELECT COUNT(*) FROM penalty WHERE ((creationDate <= @lastOfCurrentMonth AND finalizationDate >= @lastOfCurrentMonth) OR (creationDate <= @firstOfCurrentMonth AND finalizationDate >= @firstOfCurrentMonth)) AND accommodation = @accommodation);
