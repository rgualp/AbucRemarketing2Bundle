    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("
                ...
                BEGIN
                      ...
                      IF @exists = 0 THEN
                            INSERT INTO ownership_ranking_extra (accommodation,startDate,endDate,rankingPoints, awards)
                            VALUES (@accommodation,@firstOfCurrentMonth,@lastOfCurrentMonth, @rankingPoints, 5);
                      ELSE
        ...
        $this->addSql("
                ...
                BEGIN
                      ...
                      IF @exists = 0 THEN
                            INSERT INTO ownership_ranking_extra (accommodation,startDate,endDate,rankingPoints, awards)
                            VALUES (@accommodation,@firstOfCurrentMonth,@lastOfCurrentMonth, @rankingPoints, @awards);
                        ELSE
                            UPDATE ownership_ranking_extra rank
