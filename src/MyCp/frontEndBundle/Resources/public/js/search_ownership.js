...
{   
    show_loading();
    var result=$('#div_result');
    var url=$('#change_view_to_list').attr('data-url');
    
    $.post(url,{
        'view':'LIST'
    },function(data){
        result.html(data);
        /*$('#viewList').removeClass('lista');
        $('#viewList').addClass('lista_actual');
            
        $('#viewMap').removeClass('mapa_actual');
        $('#viewMap').addClass('mapa');
            
        $('#viewPhoto').removeClass('fotos_actual');
        $('#viewPhoto').addClass('fotos');*/
...
function change_view_to_photo ()
{    
    show_loading();
    var result=$('#div_result');
    var url=$('#change_view_to_photo').attr('data-url');
    
    $.post(url,{
        'view':'PHOTOS'
    },function(data){
        result.html(data);
        /*$('#viewList').removeClass('lista_actual');
        $('#viewList').addClass('lista');
            
        $('#viewMap').removeClass('mapa_actual');
        $('#viewMap').addClass('mapa');
            
        $('#viewPhoto').removeClass('fotos');
        $('#viewPhoto').addClass('fotos_actual');*/
...
function change_view_to_map ()
{    
    show_loading();
    var result=$('#div_result');
    var url=$('#change_view_to_map').attr('data-url');
    ...
    $.post(url,{
        ...
        $('#viewMap').removeClass('mapa');
        $('#viewMap').addClass('mapa_actual');
