        ...
        if ($request->getMethod() == 'POST') {
            ...
            if ($post_tourist != null) {
                ...
                if ($form_tourist->isValid()) {
                    ...
                    $service_email = $this->get('Email');
                    $service_email->send_email(
                            'Contacto de un huesped', 'noreply@mycasaparticular.com', $tourist_email, "El Sr(a). $tourist_name $tourist_last_name, con numero de telefono $tourist_phone, ha hecho el siguiente comentario: $tourist_comment", '');
            ...
            if ($post_owner != null) {
                ...
                if ($form_owner->isValid()) {
                    ...
                    $service_email = $this->get('Email');
                    $service_email->send_email(
                            'Contacto de un propietario', 'noreply@mycasaparticular.com', $owner_email, "El Sr(a). $owner_full_name, desea incluir una nueva casa con los siguientes datos:  
