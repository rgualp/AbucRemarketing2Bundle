...
class RequestListener {
    ...
    public function onKernelRequest($event)
    {
        ...
        if(isset($attr['_route']) && $attr['_route']!='frontend_change_language' && $attr['_route']!='frontend_get_reservation_calendar_ownership' && $attr['_route']!='frontend_map_details_ownership' && $attr['_route']!='_wdt' && $attr['_route']!='_internal')
        {
