...
//Pendientes
    ...
    public function pageDetailAcomodationAction($own_name, Request $request)
    {
        ...
        return $this->render('@Partner/Dashboard/accomodation_detail_view_only.html.twig', array(
            'form' => $form->createView(),
            'avail_array_prices' => $avail_array_prices,
            'available_rooms' => $available_rooms,
            'price_subtotal' => $price_subtotal,
