...
class ownershipRepository extends EntityRepository
{
        ...
        foreach ($keys as $item) {
            ...
            if (strpos($item, 'description_desc') !== false) {
                ...
                switch ($currentLanguage->getLangId()) {
                    case $targetLanguage->getLangId():
                        $targetLangCode = "de";
                        break;
                    case $targetLanguageFR->getLangId():
                        $targetLangCode = "fr";
                        break;
                    case $targetLanguageIT->getLangId():
                        $targetLangCode = "it";
                        break;
                    case $targetLanguageEN->getLangId():
                        $targetLangCode = "en";
                        break;
                }
     ...
     * @internal param int $province_id
     */
...
//        }
     ...
     * @return array of MyCp\mycpBundle\Entity\ownership
     * @internal param int $province_id
     * @internal param datetime $arrivalDate
     * @internal param datetime $leavingDate
     * @internal param int $guest_total
