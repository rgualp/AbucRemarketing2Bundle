...
class generalReservationRepository extends EntityRepository {
    ...
    function getAllPag($filter_date_reserve, $filter_offer_number, $filter_reference, $filter_date_from, $filter_date_to, $sort_by, $filter_booking_number, $filter_status, $filter_client, $items_per_page = null, $page = null, $partner = null) {
        ...
        (SELECT count(owres) FROM mycpBundle:ownershipReservation owres WHERE owres.own_res_gen_res_id = gre.gen_res_id AND owres.own_res_status!=4),
        ...
        u.user_user_name, u.user_last_name, u.user_email,u.user_id,
    ...
    function getAllPagReserved($filter_date_reserve,$filter_date_reserve2,$filterbr,$filter_agency, $filter_offer_number, $filter_reference, $filter_date_from, $filter_date_to, $sort_by, $filter_booking_number, $filter_status, $filter_client, $items_per_page = null, $page = null, $partner = true) {
        ...
        (SELECT COUNT(ofl) from mycpBundle:offerLog ofl where ofl.log_offer_reservation = gre.gen_res_id) as isOffer,
         own.own_inmediate_booking,own.own_inmediate_booking_2,
        gre.responseTime, gre.complete_payment,booking.booking_id
        FROM mycpBundle:generalReservation gre 
        ...
        JOIN gre.gen_res_own_id own
        JOIN gre.gen_res_user_id u 
        JOIN mycpBundle:ownershipReservation owres6 WITH gre.gen_res_id = owres6.own_res_gen_res_id
        JOIN owres6.own_res_reservation_booking booking
    ...
    function getByQueryReservedPag($filter_date_reserve,$filter_date_reserve2,$filterbr,$filter_agency, $filter_offer_number, $filter_reference, $filter_date_from, $filter_date_to, $sort_by, $filter_booking_number, $filter_status, $filter_client, $user_casa, $queryStr, $items_per_page = null, $page = null, $partner = null) {
        ...
        if($filter_booking_number != '' && $filter_booking_number != "-1" && $filter_booking_number != "null") {
            $where .= (($where != "") ? " AND " : " WHERE ") . "gre.gen_res_id = owres6.own_res_gen_res_id AND owres6.own_res_reservation_booking = $filter_booking_number";
        }

        if($filter_client != "") {
            $client_name = $filter_client;
            $client_name = "'%" . trim($client_name) . "%'";
            $where .= (($where != "") ? " AND " : " WHERE ") . " (SELECT COUNT(c) FROM PartnerBundle:paReservationDetail parde JOIN parde.reservation pars JOIN pars.client c WHERE parde.reservationDetail = gre.gen_res_id AND c.fullname LIKE $client_name) > 0";
        }

        $queryStr = $queryStr . $where . $string_order . $groupby;
        ...
        foreach ($data as $key => $reservation) {
            ...
            if(count($r)){
                ...
                if($filterbr != "" && $filterbr != "null" && strpos($client['reference'], $filterbr)==false ){
                    unset($data[$key]);
                    continue;
                }
    ...
    function getByQueryPag($filter_date_reserve, $filter_offer_number, $filter_reference, $filter_date_from, $filter_date_to, $sort_by, $filter_booking_number, $filter_status, $filter_client, $user_casa, $queryStr, $items_per_page = null, $page = null, $partner = null) {
        ...
        if($filter_client != "") {
            $client_name = $filter_client;
            $client_name = "'%" . trim($client_name) . "%'";
            $where .= (($where != "") ? " AND " : " WHERE ") . " (SELECT COUNT(c) FROM PartnerBundle:paReservationDetail pard JOIN pard.reservation par JOIN par.client c WHERE pard.reservationDetail = gre.gen_res_id AND c.fullname LIKE $client_name) > 0";
        }
    ...
    function getReservationsAgToExport($filter_date_reserve, $filter_offer_number, $filter_reference, $filter_date_from, $filter_date_to, $sort_by, $filter_booking_number, $filter_status, $filter_client, $date) {
        ...
        if($filter_client != "" && $filter_client != "null") {
            ...
            $qb->andWhere("(SELECT COUNT(c) FROM PartnerBundle:paReservationDetail pard JOIN pard.reservation par
            JOIN par.client c WHERE pard.reservationDetail = gres.gen_res_id AND c.fullname LIKE $client_name) > 0");
        }
...
group by gres.gen_res_id order by gres.gen_res_id DESC";
...
*/
    ...
    function getReservationMonthlySummary($filter_date_from = null, $filter_date_to = null) {
        $em = $this->getEntityManager();
        $qb = $em->createQueryBuilder();

        $qb->select("MONTHNAME(gres.gen_res_date) as fecha, MONTH(gres.gen_res_date) as month, YEAR(gres.gen_res_date) as year, count(distinct gres.gen_res_id) as cantidad, count(owres.own_res_id) as habitaciones, sum(DATE_DIFF(owres.own_res_reservation_to_date, owres.own_res_reservation_from_date)) as noches")
            ->from("mycpBundle:ownershipReservation", "owres")
            ->join("owres.own_res_gen_res_id", "gres")
            ->groupBy("month")
    ...
    function getReservationMonthlySummaryAvailable($filter_date_from = null, $filter_date_to = null) {
        $em = $this->getEntityManager();
        $qb = $em->createQueryBuilder();
    ...
    function getReservationMonthlySummaryPayments($filter_date_from = null, $filter_date_to = null) {
        $em = $this->getEntityManager();
        $qb = $em->createQueryBuilder();
    ...
    function getReservationYearlySummary($filter_date_from = null, $filter_date_to = null) {
        $em = $this->getEntityManager();
        $qb = $em->createQueryBuilder();

        $qb->select("YEAR(gres.gen_res_date) as fecha, count(distinct gres.gen_res_id) as cantidad, count(owres.own_res_id) as habitaciones, sum(DATE_DIFF(owres.own_res_reservation_to_date, owres.own_res_reservation_from_date)) as noches")
            ->from("mycpBundle:ownershipReservation", "owres")
            ->join("owres.own_res_gen_res_id", "gres")
            ->groupBy("fecha")
            ->orderBy("fecha");
    ...
    function getReservationYearlySummaryAvailable($filter_date_from = null, $filter_date_to = null) {
        $em = $this->getEntityManager();
        $qb = $em->createQueryBuilder();
    ...
    function getReservationYearlySummaryPayments($filter_date_from = null, $filter_date_to = null) {
        $em = $this->getEntityManager();
        $qb = $em->createQueryBuilder();
...
//        }
    ...
    function getClientsDailySummaryPaymentsx($filter_date_from = null, $filter_date_to = null, $accommodationModality = null) {
        ...
        $qb->select("(CASE WHEN p.current_cuc_change_rate IS NULL THEN p.payed_amount*curr.curr_cuc_change ELSE p.payed_amount*p.current_cuc_change_rate END) as facturacion")
            ->from("mycpBundle:ownershipReservation", "owres")
            ->join("owres.own_res_gen_res_id", "gres")
            ->join("owres.own_res_reservation_booking", "b")
            ->join('mycpBundle:payment', 'p', Expr\Join::WITH, 'p.booking = b.booking_id')
...
//        }
    ...
    function getPaymentByDate($filter_date_from = null, $filter_date_to = null, $accommodationModality = null){
        $em = $this->getEntityManager();
        $qb = $em->createQueryBuilder();
...
//        }
    ...
    function getClientsMonthlySummary($filter_date_from = null, $filter_date_to = null, $accommodationModality = null) {
        ...
        $qb->select("MONTHNAME(gres.gen_res_date) as fecha, MONTH(gres.gen_res_date) as month, YEAR(gres.gen_res_date) as year, count(distinct gres.gen_res_user_id) as clientes, count(distinct gres.gen_res_id) as solicitudes, sum(owres.own_res_count_adults +owres.own_res_count_childrens ) as personas_involucradas, count(owres.own_res_id) as habitaciones, sum(DATE_DIFF(owres.own_res_reservation_to_date, owres.own_res_reservation_from_date)) as noches")
            ->from("mycpBundle:ownershipReservation", "owres")
            ->join("owres.own_res_gen_res_id", "gres")
            ->groupBy("month")
            ->orderBy("year ASC, month");
    ...
    function getClientsMonthlySummaryPaymentsFacturation($filter_date_from = null, $filter_date_to = null, $accommodationModality = null) {
        ...
        $qb->select("MONTHNAME(DATE(p.created)) as fecha, MONTH(p.created) as month, YEAR(p.created) as year, count(distinct gres.gen_res_user_id) as clientes, count(distinct gres.gen_res_id) as solicitudes, sum(owres.own_res_count_adults +owres.own_res_count_childrens ) as personas_involucradas,
        count(owres.own_res_id) as habitaciones, sum(DATE_DIFF(owres.own_res_reservation_to_date, owres.own_res_reservation_from_date)) as noches,
         (SELECT SUM(CASE WHEN p1.current_cuc_change_rate IS NOT NULL THEN p1.payed_amount*p1.current_cuc_change_rate ELSE p1.payed_amount*curr.curr_cuc_change END) from mycpBundle:payment p1 WHERE MONTH(p1.created)=month AND YEAR(p1.created)=year ) as facturacion")
            ->from("mycpBundle:ownershipReservation", "owres")
            ->join("owres.own_res_gen_res_id", "gres")
            ->join("owres.own_res_reservation_booking", "b")
            ->join('mycpBundle:payment', 'p', Expr\Join::WITH, 'p.booking = b.booking_id')
...
//            $qb->andWhere("gres.gen_res_date >= '$filter_date_from' AND gres.gen_res_date <= '$filter_date_to'");
    ...
    function getClientsYearlySummary($filter_date_from = null, $filter_date_to = null, $accommodationModality = null) {
        ...
        $qb->select("YEAR(gres.gen_res_date) as fecha, count(distinct gres.gen_res_user_id) as clientes, count(distinct gres.gen_res_id) as solicitudes, sum(owres.own_res_count_adults +owres.own_res_count_childrens ) as personas_involucradas, count(owres.own_res_id) as habitaciones, sum(DATE_DIFF(owres.own_res_reservation_to_date, owres.own_res_reservation_from_date)) as noches")
            ->from("mycpBundle:ownershipReservation", "owres")
            ->join("owres.own_res_gen_res_id", "gres")
            ->groupBy("fecha")
            ->orderBy("fecha");
...
//            $qb->andWhere("gres.gen_res_date >= '$filter_date_from' AND gres.gen_res_date <= '$filter_date_to'");
    ...
    function getClientsYearlySummaryOnlyFacturationx($year) {
        $em = $this->getEntityManager();
        $qb = $em->createQueryBuilder();
...
//            }
    ...
    function getByUsersAg($filter_name = "", $filter_agencia = "", $filter_status = "", $filter_accommodation = "", $filter_destination = "", $filter_range_from = "", $filter_range_to = "") {
        ...
        $queryString = "SELECT pa_client.fullname, pa_client.id as idClient,genRes.gen_res_date, age.`name` as agency_name,age.id as agencyid, u.user_id, u.user_user_name, u.user_last_name,
             SUM(DATEDIFF(owres.own_res_reservation_to_date, owres.own_res_reservation_from_date)) as nights,
            COUNT(DISTINCT genRes.gen_res_id) as total,
            MAX(genRes.gen_res_date_hour) as hourRes,
            MAX(genRes.gen_res_hour) as hourSavedRes
            FROM ownershipreservation owres
            join generalreservation genRes on genRes.gen_res_id = owres.own_res_gen_res_id
join pa_reservation_detail on genRes.gen_res_id = pa_reservation_detail.reservationDetail
join pa_reservation on pa_reservation.id =pa_reservation_detail.reservation
join pa_client on pa_client.id =pa_reservation.client
...
join user u on genRes.gen_res_user_id = u.user_id
    ...
    function getAccommodationsFromReservationsByClient($idClient, $reservationDate) {
        ...
        $queryString = "select DISTINCT o.own_mcp_code, o.own_id, o.own_inmediate_booking,o.own_inmediate_booking_2
            ...
            order by LENGTH(o.own_mcp_code), o.own_mcp_code";
...
where  cl.id = :idClient and gres.gen_res_date = :reservationDate and gres.gen_res_status = :status
order by LENGTH(o.own_mcp_code), o.own_mcp_code";
    ...
    function getDestinationsFromReservationsByClient($idClient, $reservationDate) {
        $em = $this->getEntityManager();
        /*$queryString = "select d.des_id, d.des_name,
    ...
    function getDestinationsFromReservationsByClientAG($idClient, $reservationDate) {
        $em = $this->getEntityManager();
        /*$queryString = "select d.des_id, d.des_name,
            SUM(if(gres.gen_res_status = :pendingStatus, 1, 0)) as pending,
            SUM(if(gres.gen_res_status = :notAvailable, 1, 0)) as notAvailable,
        ...
        $queryString = "select d.des_id,cl.id, d.des_name,owres.own_res_reservation_from_date,
            SUM(if(gres.gen_res_status = :pendingStatus, 1, 0)) as pending,
            SUM(if(gres.gen_res_status = :notAvailable, 1, 0)) as notAvailable,
            SUM(if(gres.gen_res_status = :available or gres.gen_res_status = :payed or gres.gen_res_status = :cancelled or gres.gen_res_status = :outdated, 1, 0)) as available,
            SUM(if(gres.gen_res_status = :payed, 1, 0)) as payed,
    ...
    function getClientStatusByDate($idClient, $reservationDate) {
        $em = $this->getEntityManager();
        $queryString = "select d.des_id, d.des_name,owres.own_res_reservation_from_date,
            SUM(if(gres.gen_res_status = :pendingStatus, 1, 0)) as pending,
            SUM(if(gres.gen_res_status = :notAvailable, 1, 0)) as notAvailable,
...
JOIN owres_2.own_res_reservation_booking AS b1 JOIN b1.payments AS p WHERE owres_2.own_res_gen_res_id = r.gen_res_id AND p.created >= :created1  AND p.created <= :created2";
    ...
    function getReservationsPartnerByStatusArray($idUser, $statusArray, array $filters, $start, $limit) {
        $qb = $this->createQueryBuilder('r');
        ...
        foreach($statusArray as $status) {
            if ($status == generalReservation::STATUS_RESERVED) {
                ...
                $qb->andWhere('r.gen_res_status = '.$status);
            }
        }
