...
class ownershipReservationRepository extends EntityRepository {
    ...
    function getReservationReservedByRoomAndDateForCalendar($roomId, $startParam, $endParam) {
        ...
        AND ((ore.own_res_reservation_from_date <= :start AND ore.own_res_reservation_to_date > :start) OR
             (ore.own_res_reservation_from_date <= :end AND ore.own_res_reservation_to_date > :end))
