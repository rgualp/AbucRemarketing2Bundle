...
class SummaryCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output) {
        ...
        try {
            ...
            $emailService->sendEmail(array('ptorres@mycasaparticular.com','damian.flores@mycasaparticular.com','ander@mycasaparticular.com'), $subject,  $body, 'no-responder@mycasaparticular.com');
