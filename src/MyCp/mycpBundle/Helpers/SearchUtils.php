...
class SearchUtils {
    ...
    public static function getFilterWherePartner($filters) {
        ...
        if ($filters != null && is_array($filters)) {
            ...
            if (($filters['room'] != "") && (array_key_exists('room_type', $filters) && $filters['room_type'] != null && is_array($filters['room_type']) && count($filters['room_type']) > 0)){
                $insideWhere = SearchUtils::getStringFromArray($filters['room_type']);
                $where .= " AND " . "(SELECT count(r1) FROM mycpBundle:room r1 WHERE  r1.room_type = $insideWhere AND r1.room_ownership=o.own_id) >= ".$filters['room'];
            }
      ...
      switch($order_by)
        {
            ...
            case OrderByHelper::SEARCHER_BEST_VALUED:
                return "  ORDER BY o.own_comments_total DESC, o.own_inmediate_booking_2 DESC, o.own_ranking DESC, count_reservations DESC, o.own_availability_update DESC ";
            case OrderByHelper::SEARCHER_A_Z:
                return "  ORDER BY o.own_name ASC, o.own_inmediate_booking_2 DESC, o.own_ranking DESC, o.own_comments_total DESC, count_reservations DESC, o.own_availability_update DESC ";
            case OrderByHelper::SEARCHER_Z_A:
                return "  ORDER BY o.own_name DESC, o.own_inmediate_booking_2 DESC, o.own_ranking DESC, o.own_comments_total DESC, count_reservations DESC, o.own_availability_update DESC ";
            case OrderByHelper::SEARCHER_PRICE_HIGH_LOW:
                return "  ORDER BY o.own_minimum_price DESC, o.own_inmediate_booking_2 DESC, o.own_ranking DESC, o.own_comments_total DESC, count_reservations DESC, o.own_availability_update DESC ";
            case OrderByHelper::SEARCHER_PRICE_LOW_HIGH:
                return "  ORDER BY o.own_minimum_price ASC, o.own_inmediate_booking_2 DESC, o.own_ranking DESC, o.own_comments_total DESC, count_reservations DESC, o.own_availability_update DESC ";
            case OrderByHelper::SEARCHER_RESERVATIONS_HIGH_LOW:
                return "  ORDER BY count_reservations DESC,o.own_inmediate_booking_2 DESC, o.own_ranking DESC, o.own_comments_total DESC, o.own_availability_update DESC ";
            case OrderByHelper::SEARCHER_RESERVATIONS_LOW_HIGH:
                return "  ORDER BY count_reservations ASC,o.own_inmediate_booking_2 DESC, o.own_ranking DESC, o.own_comments_total DESC, o.own_availability_update DESC ";
