...
class commentType extends AbstractType
{
    ...
    {
        $builder
            ->add('com_ownership',null,array('label'=>'Propiedad:','empty_value'=>'', 'attr'=>array('class'=>'input-block-level')))
            ->add('com_user',null,array('label'=>'Usuario:','empty_value'=>'','attr'=>array('class'=>'input-block-level')))
